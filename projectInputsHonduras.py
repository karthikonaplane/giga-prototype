...
#General project inputs framework, customized for Honduras
...
demo = {
    ...
    "schoolAgeFraction" : 0.328, #37% of Hondurans between ages 5-19 - https://www.populationpyramid.net/honduras/2017/
    "schoolEnrollmentFraction" : 0.853, #85.3% of eligible Hondurans enrolled in school
