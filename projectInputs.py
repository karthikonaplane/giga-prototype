...
#General project inputs framework, using Kenya as a template
...
demo = {
    ...
    "schoolAgeFraction" : 0.37, #37% of Kenyans between ages 5-19
    "schoolEnrollmentFraction" : 0.76, #76% of eligible Kenyan's enrolled in school
